...
dat_msb$Reason[dat_msb$Reason != "Fel i utrustning"& dat_msb$Reason != "Avsiktlig brand"& dat_msb$Reason != "Ok�nd"] <-"Other Reason"
...
dat_msb$Reason[dat_msb$Reason == "Ok�nd"] <- "Unknown"
