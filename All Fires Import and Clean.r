...
# Subset fires from SkÃ¥ne, VÃ¤stra GÃ¶tland and Stockholm

#dat_skÃ¥ne <- filter(dat_msb, dat_msb$Region_Code == 12)
#dat_gÃ¶teborg <- filter(dat_msb, dat_msb$Region_Code == 14)
