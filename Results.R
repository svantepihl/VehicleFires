...
screenreg(list(model_months_plm_fixed_lsdv, model_months_plm_random, model_months_plm_first_difference))

??screenreg

rm(model_months_plm_fixed,model_months_plm_first_difference,model_months_plm_random,model_months_plm_fixed_lsdv)
